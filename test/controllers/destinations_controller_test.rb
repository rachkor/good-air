...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { city: @destination.city, country: @destination.country, description: @destination.description, name: @destination.name, state: @destination.state }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { city: @destination.city, country: @destination.country, description: @destination.description, name: @destination.name, state: @destination.state }
    assert_redirected_to destination_path(assigns(:destination))
  end
